...
p1 <- dotplot(edo, showCategory= as.numeric(args[3])) + ggtitle("ORA Dotplot\n") + theme(plot.title = element_text(size=18,hjust = 0.5))
ggsave2(file=file.path("/Hermes", args[7] , "plot1.svg"), plot=p1,width = 11,height = 8.5)

ChangeSVGBasic(file.path("/Hermes", args[7] , "plot1.svg"),temp)
} else{
